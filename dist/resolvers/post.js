...
class PostResolver {
    ...
    post(id, { em }) {
        return em.findOne(Post_1.default, { id });
    }
    createPost(title, { em }) {
        return __awaiter(this, void 0, void 0, function* () {
            const post = yield em.create(Post_1.default, { title });
    ...
    updatePost(id, title, { em }) {
        return __awaiter(this, void 0, void 0, function* () {
            const post = yield em.findOne(Post_1.default, { id });
            if (!post) {
                return null;
            }
    ...
    deletePost(id, { em }) {
        return __awaiter(this, void 0, void 0, function* () {
            yield em.nativeDelete(Post_1.default, { id });
            return true;
        });
    }
}
